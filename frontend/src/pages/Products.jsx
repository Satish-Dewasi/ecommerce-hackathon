          ...
          {[1, 2, 3, 4, 5].map((r) => (
            <button
              ...
              onClick={() =>
                setFilter(
                  "minRating",
                  filters.minRating === String(r) ? "" : String(r),
                )
              }
            ...
            >
              <Star
                className="w-3 h-3"
                fill={filters.minRating === String(r) ? "currentColor" : "none"}
              />
              {r}+
            </button>
          ))}
          ...
          <div className="relative ml-auto w-[300px] h-full bg-background overflow-y-auto p-6 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold">
                Filters{" "}
                {activeCount > 0 && (
                  <span className="ml-2 text-xs bg-foreground text-background rounded-full px-2 py-0.5">
                    {activeCount}
                  </span>
                )}
              </h2>
                  ...
                  >
                    <div className="rounded-xl overflow-hidden mb-3 bg-secondary/30 relative">
                      <img
                        src={
                          product.thumbnail ||
                          "https://placehold.co/400x500/f5f5f5/999?text=No+Image"
                        }
                        alt={product.name}
